...
Pré-requisito: É necessário que você tenha um editor como o Eclipse ou Netbeans.

## Clone este repositório
$ git clone https://github.com/AACJ/Star_of_Tomorrow.git

## Execução

Abra a pasta no seu editor, aperte em build e execute.
