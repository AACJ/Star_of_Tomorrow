...
public class Tela_game_over1 extends javax.swing.JFrame {

    private ImageIcon icon = new ImageIcon("img\\Nave4.png");
     
    public Tela_game_over1() {
        initComponents();
        setVisible(true);
        setSize(600, 630);
    ...
    private void initComponents() {
        ...
        mercurio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/folder/Mercurio.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_game_over1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_game_over1().setVisible(true);
            }
        });
    }
