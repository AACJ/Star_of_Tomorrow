 ...
 * @author CONTROLLER
 */
public class Cut2_1 extends JFrame implements ActionListener{
    
    private ImageIcon icon = new ImageIcon("img\\Nave4.png");
    private ImageIcon fundo = new ImageIcon("img\\custcene 2.1.png");
    ...
    public Cut2_1(){
        ...
        linha1.setText("Com o passar do tempo o rei Dorian encontrou seu");
        linha1.setBounds(80, 420, 480, 18);
        painel.add(linha1);
        
        linha2.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 14)); // NOI18N
        linha2.setForeground(new java.awt.Color(255, 255, 255));
        linha2.setText("amor em Aurora,  que é bondosa e partilhava dos ");
        ...
        linha3.setText("mesmos sentimentos para com o povo.");
        linha3.setBounds(80, 480, 420, 18);
        painel.add(linha3);
