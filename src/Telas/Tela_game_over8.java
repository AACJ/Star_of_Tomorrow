...
public class Tela_game_over8 extends javax.swing.JFrame {

    private ImageIcon icon = new ImageIcon("img\\Nave4.png");
    private Tela_mapa mp;
    
    public Tela_game_over8() {
        initComponents();
        setVisible(true);
        setSize(600, 630);
    ...
    private void initComponents() {
        ...
        mercurio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/folder/Netuno.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_game_over8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_game_over8().setVisible(true);
            }
        });
    }
