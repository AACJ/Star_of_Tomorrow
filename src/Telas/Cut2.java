 ...
 * @author CONTROLLER
 */
public class Cut2 extends JFrame implements ActionListener{
    
    private ImageIcon icon = new ImageIcon("img\\Nave4.png");
    private ImageIcon fundo = new ImageIcon("img\\custcene 2.png");
    ...
    public Cut2(){
        ...
        linha1.setText("No planeta Apolo situado na galáxia Andrômeda.");
        linha1.setBounds(80, 420, 460, 18);
        painel.add(linha1);
        ...
        linha2.setText("O rei Dorian era um rei bondoso e que governava seu");
        linha2.setBounds(80, 450, 600, 18);
        painel.add(linha2);

        linha3.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 14)); // NOI18N
        linha3.setForeground(new java.awt.Color(255, 255, 255));
        linha3.setText("planeta com grande sabedoria.");
        linha3.setBounds(80, 480, 300, 18);
        painel.add(linha3);
