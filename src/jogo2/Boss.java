...
public class Boss {
    ...
    //Variavel para o tiro Boss 2
    private List<TiroBoss> tiroBoss2;
    ...
    public Boss() {
        x = 100;
        y = -500;
        Boss = new ImageIcon("img\\boss2.png");
        ...
        tiroBoss2 = new ArrayList<TiroBoss>();
    }
    ...
    public void atirar2() {
        ...
        TimerTask tarefa = new TimerTask() {
            @Override
            public void run() {
                tiroBoss2.add(new TiroBoss(x + 60, y + 230, limite));
